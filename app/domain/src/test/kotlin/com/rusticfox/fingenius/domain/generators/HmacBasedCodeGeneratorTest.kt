...
class HmacBasedCodeGeneratorTest {
    ...
    private val hmacConfig = com.rusticfox.fingenius.domain.generators.HmacCodeGeneratorConfig(
        codeDigits = codeDigits,
        hmacAlgorithm = HmacAlgorithms.SHA1,
    )

    private val hmacBasedOtpCodeGenerator by lazy {
        com.rusticfox.fingenius.domain.generators.HmacBasedCodeGenerator(key, hmacConfig)
    }
