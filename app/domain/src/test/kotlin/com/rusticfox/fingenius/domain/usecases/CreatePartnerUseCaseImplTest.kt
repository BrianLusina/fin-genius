...
class CreatePartnerUseCaseImplTest {
    ...
    private val mockOtpGenerator = mockk<com.rusticfox.fingenius.core.usecases.OtpCodeGenerator>()
    private val createOtpService = CreatePartnerUseCaseImpl(
    ...
    fun `should throw error if there is a failure saving generated OTP code`() {
        val generatedCode = com.rusticfox.fingenius.core.usecases.GeneratedOtpCode(
            code = "123456",
